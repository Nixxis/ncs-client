...
namespace System.Windows.Controls.WpfPropertyGrid
{
    public partial class PropertyGrid
    {
        ...
        protected void InitializeCommandBindings()
        {
            ...
            CommandBindings.Add(new CommandBinding(PropertyEditorCommands.ShowDialogEditor, OnShowDialogEditor, OnCanExecuteShowDialogEditor));
        }
        ...
        private void OnCanExecuteShowDialogEditor(object sender, CanExecuteRoutedEventArgs e)
        {
            e.CanExecute = true;
            e.Handled = true;
        }
