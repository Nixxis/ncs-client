  ...
  public class EnumValueConverter : IValueConverter
  {
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
      if (value is Enum)
      {
        ...
        return ((attributes.Length > 0) && (!String.IsNullOrEmpty(attributes[0].Description))) ? (new TranslationContext("Enum" + value.GetType().Name)).Translate(attributes[0].Description) : (new TranslationContext("Enum" + value.GetType().Name)).Translate(value.ToString());
      }
      ...
      {
        return (new TranslationContext("Enum" + value.GetType().Name)).Translate(value.ToString());
      }
    }
